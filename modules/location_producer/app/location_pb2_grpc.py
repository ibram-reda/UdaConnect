...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.PushLocation = channel.unary_unary(
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PushLocation': grpc.unary_unary_rpc_method_handler(
                    servicer.PushLocation,
...
class LocationService(object):
    ...
    def PushLocation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LocationService/PushLocation',
